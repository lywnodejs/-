     ...
     <el-menu-item>
      ...
      <el-submenu index="1">
        <template slot="title">
          ...
          <el-menu-item index="c_inform">消息管理</el-menu-item>
          <el-menu-item index="c_push">push管理</el-menu-item>
          <el-menu-item index="c_class">分类管理</el-menu-item>
          <el-menu-item index="scrollbarManagement">滚动条管理</el-menu-item>
      </el-submenu>
      <el-menu-item 
